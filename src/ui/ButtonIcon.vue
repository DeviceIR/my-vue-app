...
<template>
  <button
    class="xl:w-1/2 xl:h-[3rem] lg:w-1/2 lg:h-[2.4rem] md:w-[2rem] md:h-[2rem] sm:w-[3rem] sm:h-[2rem] py-[0.6rem] px-[1.2rem] md:p-0 flex justify-center items-center sm:p-0"
    :class="[
